...
function Song(props: Props) {
    ...
    let paused: number | null = parseInt(
        useSearchParams().get("paused") || "0"
    );
    ...
    const handlePlay = (e: any) => {
        ...
        if (url.searchParams.get("id") == data?.id) {
            if (window.ReactNativeWebView) {
                ...
                if (url.searchParams.get("paused")) window.playSongRN();
                else window.pauseSongRN();
                return;
            }
        ...
        else url.searchParams.append("id", songBarID || "");
    ...
    return (
        <Flex
            ...
            cursor={"pointer"}
            onClick={() => {
                handleRouteChange("/song/" + props.data?.id);
            }}
                ...
                <Skeleton
                    ...
                    <Flex
                        ...
                        <Image
                            ...
                            loader={() =>
                                data?.image[2].link + "?w=3.4rem&h=auto" || ""
                            }
                            height={54}
                            width={54}
                            minWidth={"3.4rem"}

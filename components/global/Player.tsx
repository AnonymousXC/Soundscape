...
function Player() {
    ...
    return (
        <Flex display={['flex', 'flex', 'flex']} width={'100%'} height={['8.2rem', '8.2rem', '6.25rem']} position={['fixed', 'fixed', 'absolute']} backgroundColor={'background'} bottom={["3.875rem", "3.875rem", "0"]} left={0} zIndex={100} justifyContent={'space-evenly'} boxShadow={'1px 3px 25px rgb(0 0 0 / 0.8)'} flexDirection={['column-reverse', 'column-reverse', 'row']} pt={[1,1,0]} gap={[1,1,0]} px={[4,4,0]}>

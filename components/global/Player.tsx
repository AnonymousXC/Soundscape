...
function Player() {
    ...
    useEffect(() => {
        ...
        window.changeSong = function (internalID: string) {
            ...
            if (url.searchParams.get("id") === internalID) return;
    ...
    const handleSongEnd = () => {
        ...
        if (url.searchParams.has("id"))
            url.searchParams.set(
                "id",
                nextSuggestedSong[nextSuggestedSong.indexOf(id) + 1] || ""
            );
        else
    ...
    const playPrevious = () => {
        ...
        if (nextSuggestedSong.indexOf(id) >= 1) {
            ...
            if (url.searchParams.has("id")) url.searchParams.set("id", prevID);
            else url.searchParams.append("id", prevID);
            ...
            <Flex
                ...
                <Flex
                    ...
                    <Skeleton isLoaded={loaded} rounded={"full"}>
                        <Flex
                            ...
                            height={"4.4rem"}
                            rounded={"full"}
                            className="border-image-gradient"
                ...
                <Flex
                    ...
                    <Button
                        ...
                        <Img
                            src={"/icons/player/Play Previous.svg"}
                            height={"1rem"}
                            width={"auto"}
                        />
                    </Button>
                    ...
                    <Button
                        ...
                        height={"40px"}
                        rounded={"full"}
                        backgroundImage={"var(--var-main-dark-gradient)"}
                        display={"flex"}
                        justifyContent={"center"}
                        alignItems={"center"}
                        onClick={() => {
                    ...
                    <Button
                        ...
                        <Img
                            src={"/icons/player/Play Next.svg"}
                            height={"1rem"}
                            width={"auto"}
                        />
                    </Button>
                ...
                <audio
                    ...
                    onTimeUpdate={(e) => {
                        setCurrentTime(
                            Math.floor(audio.current?.currentTime || 0)
                        );
                    }}
                    loop={loop}></audio>
                ...
                <Stack
                    width={"100%"}
                    maxWidth={["100%", "100%", "27rem"]}
                    ml={[0, 0, "1.8rem"]}
                    justifyContent={"center"}
                    gap={"2px"}>
                    <Slider
                        max={parseInt(data?.duration || "100")}
                        value={currentTime}
                        defaultValue={0}
                        min={0}
                        ...
                        <SliderTrack backgroundColor={"#464646"}>
                            <SliderFilledTrack
                                background={
                                    "linear-gradient(to right, #B5179E , #7209B7)"
                                }
                            />
                        </SliderTrack>
                        <SliderThumb
                    ...
                    <Flex justifyContent={"space-between"}>
                        <Text fontSize={"0.625rem"} color={"primaryText"}>
                            {calculateTime(parseInt(data?.duration ?? "0"))}
                        </Text>
                        <Text fontSize={"0.625rem"} color={"primaryText"}>
                            {calculateTime(currentTime || 0)}
                        </Text>
                    </Flex>
                </Stack>
                <Flex

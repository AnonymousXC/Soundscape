    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} scrollBehavior='inside' isCentered>
            ...
            <ModalContent mx={2}>
                ...
                <ModalBody>
                    <a href="https://dogeminingpaid.com/?ref=Thearcane..." target="_blank">
                ...
                <ModalFooter display={'flex'} justifyContent='space-between'>
                    <Text>Contact <a href="https://discord.com/users/913777629142876200" style={{ color: 'tomato', cursor: 'pointer', fontWeight: 'bolder' }} target='_blank'>here</a> for ads</Text>
